...
#ifndef __noisy_uitofp_32nsdEe__HH__
#define __noisy_uitofp_32nsdEe__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(noisy_uitofp_32nsdEe) {
    ...
    SC_CTOR(noisy_uitofp_32nsdEe):  ACMP_uitofp_U ("ACMP_uitofp_U") {
